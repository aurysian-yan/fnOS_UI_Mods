...
* [简体中文](/docs/core-concepts/app-entry)
...
入口配置文件Update![​](#入口配置文件update "入口配置文件update的直接链接")
---------------------------------------------------
...
### 桌面图标配置示例[​](#桌面图标配置示例 "桌面图标配置示例的直接链接")
...
### 文件右键配置示例[​](#文件右键配置示例 "文件右键配置示例的直接链接")
...
### 文件相关字段说明[​](#文件相关字段说明 "文件相关字段说明的直接链接")
...
### 控制字段说明[​](#控制字段说明 "控制字段说明的直接链接")

提示

**应用中心　》　应用设置　》　控制字段**

![应用设置控制字段示例](/assets/images/2025-12-29_211754_351-defbda49be681a082cd3f4f7bc5cd5b7.png)
...
### 文件类型支持[​](#文件类型支持 "文件类型支持的直接链接")

* 只声明应用真正支持的文件类型
* 考虑文件类型的关联性
* 提供清晰的描述说明

### 打开方式选择[​](#打开方式选择 "打开方式选择的直接链接")
...
📚 【基础】应用资源](/docs/core-concepts/resource)[下一页
